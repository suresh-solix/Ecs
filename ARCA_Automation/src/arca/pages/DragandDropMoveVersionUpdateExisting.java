...
public static void DragandDropMoveVersionUpdateExisting_Multi_files_folders()
{
	...
	//	Navigation.login();
		...
		captureScreenShot(ScreenShotsFilePath +"DragandDropMoveVersionUpdateExisting_Multi_files_folders_success.png");
		Thread.sleep(2000);
		ATUReports.add("DragandDropMoveVersionUpdateExisting_Multi_files_folders successfully","DragandDropMoveVersionUpdateExisting_Multi_files_folders",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		Thread.sleep(2000);
		}
