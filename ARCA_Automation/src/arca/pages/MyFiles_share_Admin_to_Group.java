...
public class MyFiles_share_Admin_to_Group  extends Navigation {

	static WebDriver driver;
	static Actions actions;
  

	private static Logger log = Logger.getLogger(MyFiles_share_Admin_to_Group.class.getName());
	public static String Home_Page = "https://app.solixecsdev.com/login";
	public MyFiles_share_Admin_to_Group(WebDriver driver) {
		super(driver);
		this.driver = driver;
		//driver.manage().timeouts().implicitlyWait(60,TimeUnit.SECONDS).pageLoadTimeout(60, TimeUnit.SECONDS);
		ATUReports.setWebDriver(driver);
		ATUReports.setTestCaseReqCoverage("MyFiles_share_Admin_to_Group");
		setIndexPageDescription();
		setAuthorInfoForReports();
		log.info("--------------------MyFiles_share_Admin_to_Group--------------------");
		captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group.png");
	}
	...
	private void setIndexPageDescription() {
		ATUReports.indexPageDescription = "MyFiles_share_Admin_to_Group";
	}



	//--------------------------------------MyFiles_share_Admin_to_Group_Edit_Permission----------------------------------


	public static void MyFiles_share_Admin_to_Group_Edit_Permission() 
	{
		...
		try
		{
			...
			if(file1.equals(file2))
			{
				...
				captureScreenShot(ScreenShotsFilePath +"MyFiles_share_Admin_to_Group_Edit_Permission_success.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Edit_Permission successfully","MyFiles_share_Admin_to_Group_Edit_Permission",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE)); 
				Thread.sleep(2000); 
			}
			else 
			{
				captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Edit_Permission_failed.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Edit_Permission failed","MyFiles_share_Admin_to_Group_Edit_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
				Thread.sleep(2000);
			}

			if(folder1.equals(folder2))
			{
				log.info("--------------------------No of Shared  Folders name is  equal to before ------------------------------");
			...
			String file4 =driver.findElement(By.xpath("//div[contains(text(),'New pdf 1.pdf')]")).getText();
			System.out.println(file4);

			String folder4 =driver.findElement(By.xpath("//div[contains(text(),'fol 1')]")).getText();
			...
			if(file1.equals(file4))
			{
				...
				log.info("--------------------------No of Shared Files is  equal to before name------------------------------");
			...
			if(folder1.equals(folder4))
			{

				log.info("--------------------------No of Shared Folders is  equal to before name------------------------------");
		...
		catch (Exception e)
		{
			...
			e.printStackTrace();
			log.error("Error in MyFiles_share_Admin_to_Group_Edit_Permission",e);	
			//log.fatal(e.getMessage(),e);
			captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Edit_Permission_failed_Error.png");
			ATUReports.add("MyFiles_share_Admin_to_Group_Edit_Permission failed","MyFiles_share_Admin_to_Group_Edit_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		}
	}
	...
	//-----------------------------MyFiles_share_Admin_to_Group_Commenter_Permission-------------------------------------------


	public static void MyFiles_share_Admin_to_Group_Commenter_Permission() 
	{
	...
	//		getPageObject("search_result_first_element").click(); 
			...
			if(file1.equals(file2))
			{
				...
				captureScreenShot(ScreenShotsFilePath +"MyFiles_share_Admin_to_Group_Commenter_Permission_success.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Commenter_Permission successfully","MyFiles_share_Admin_to_Group_Commenter_Permission",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE)); 
				Thread.sleep(2000); 
			}
			else 
			{
				captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Commenter_Permission_failed.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Commenter_Permission failed","MyFiles_share_Admin_to_Group_Commenter_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
				Thread.sleep(2000);
			}
		...
		catch (Exception e)
		{
			...
			System.out.println("errror at: ");
			e.printStackTrace();
			log.error("Error in MyFiles_share_Admin_to_Group_Commenter_Permission",e);	
			//log.fatal(e.getMessage(),e);
			captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Commenter_Permission_failed_Error.png");
			ATUReports.add("MyFiles_share_Admin_to_Group_Commenter_Permission failed","MyFiles_share_Admin_to_Group_Commenter_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		}
	}
		...
		//---------------------------------------MyFiles_share_Admin_to_Group_View_Permission------------------------------------------------------

		
	public static void MyFiles_share_Admin_to_Group_View_Permission() 
	{
		...
		try
		{
			...
			if(file1.equals(file2))
			{
				...
				captureScreenShot(ScreenShotsFilePath +"MyFiles_share_Admin_to_Group_View_Permission_success.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_View_Permission successfully","MyFiles_share_Admin_to_Group_View_Permission",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE)); 
				Thread.sleep(2000); 
			}
			else 
			{
				captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_View_Permission_failed.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_View_Permission failed","MyFiles_share_Admin_to_Group_View_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
				Thread.sleep(2000);
			}
		...
		catch (Exception e)
		{
			...
			System.out.println("errror at: ");
			e.printStackTrace();
			log.error("Error in MyFiles_share_Admin_to_Group_View_Permission",e);	
			//log.fatal(e.getMessage(),e);
			captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_View_Permission_failed_Error.png");
			ATUReports.add("MyFiles_share_Admin_to_Group_View_Permission failed","MyFiles_share_Admin_to_Group_View_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		}
	}
	...
	//------------------------------------MyFiles_share_Admin_to_Group_Preview_Permission--------------------------------


	public static void MyFiles_share_Admin_to_Group_Preview_Permission() 
	{
		...
		try
		{
			...
			if(file1.equals(file2))
			{
				...
				captureScreenShot(ScreenShotsFilePath +"MyFiles_share_Admin_to_Group_Preview_Permission_success.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Preview_Permission successfully","MyFiles_share_Admin_to_Group_Preview_Permission",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE)); 
				Thread.sleep(2000); 
			}
			else 
			{
				captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Preview_Permission_failed.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Preview_Permission failed","MyFiles_share_Admin_to_Group_Preview_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
				Thread.sleep(2000);
			}
		...
		catch (Exception e)
		{
			...
			System.out.println("errror at: ");
			e.printStackTrace();
			log.error("Error in MyFiles_share_Admin_to_Group_Preview_Permission",e);	
			//log.fatal(e.getMessage(),e);
			captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Preview_Permission_Error.png");
			ATUReports.add("MyFiles_share_Admin_to_Group_Preview_Permission failed","MyFiles_share_Admin_to_Group_Preview_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		}
	}


		//------------------------------------MyFiles_share_Admin_to_Group_Upload_Permission--------------------------------



	public static void MyFiles_share_Admin_to_Group_Upload_Permission() 
	{
		...
		try
		{
			...
			if(file1.equals(file2))
			{
				...
				captureScreenShot(ScreenShotsFilePath +"MyFiles_share_Admin_to_Group_Upload_Permission_success.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Upload_Permission successfully","MyFiles_share_Admin_to_Group_Upload_Permission",LogAs.PASSED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE)); 
				Thread.sleep(2000); 
			}
			else 
			{
				captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Upload_Permission_failed.png");
				Thread.sleep(2000);
				ATUReports.add("MyFiles_share_Admin_to_Group_Upload_Permission failed","MyFiles_share_Admin_to_Group_Upload_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
				Thread.sleep(2000);
			}
		...
		catch (Exception e)
		{
			...
			System.out.println("errror at: ");
			e.printStackTrace();
			log.error("Error in MyFiles_share_Admin_to_Group_Upload_Permission",e);	
			//log.fatal(e.getMessage(),e);
			captureScreenShot(ScreenShotsFilePath + "MyFiles_share_Admin_to_Group_Upload_Permission_Error.png");
			ATUReports.add("MyFiles_share_Admin_to_Group_Upload_Permission failed","MyFiles_share_Admin_to_Group_Upload_Permission",LogAs.FAILED,new CaptureScreen(ScreenshotOf.BROWSER_PAGE));
		}
	}
		...
		//-------------------------------------MyFiles_share_Admin_to_Group_Remove_Files_And_Folders------------------------------------


	public static void MyFiles_share_Admin_to_Group_Remove_Files_And_Folders() 
	{
